...
const btnWrap = document.querySelector('.btn-container');
...
const displayMenuItems = (menuItems) => {
  ...
  menuWrap.innerHTML = displayMenu;
...
const displayFilterBtns = () => { 
  ...
  btnWrap.innerHTML = categoryBtn;
  const filterBtns = btnWrap.querySelectorAll('.filter-btn');

  filterBtns.forEach( button =>  {
    button.addEventListener('click', function(pressedBtn) {
      const category = pressedBtn.currentTarget.dataset.category;
