...
if (giftArticle) {
  ...
  const deadlineAmountInNumbers = giftArticle.querySelectorAll('.deadline-format h4');
  const deadlineAmountInWords = giftArticle.querySelectorAll('.deadline-format span');
